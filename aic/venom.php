...
<body>
    ...
    <div class="v1" id="v1">
        ...
        <p>มีผู้ป่วยเจ็บบางรายอาจเกิดอาการแพ้อย่างรุนแรง มีผื่นขึ้นตามตัว หรือเป็นมากจนหายใจไม่ออก ทําให้เสียชีวิตได้</p>
        <div class="contact-1">
            <button id="helpButton1" class="first-aid" onclick="openPopup('popup1'); return false;">วิธีการปฐมพยาบาลเบื้องต้น</button>
        </div>
        ...
        <div id="precautionsPopup1" class="popup">
            <div class="popup-content">
                ...
                <p >3. ห้ามใช้แรงดึงหรือบีบออก ควรใช้ของแบนๆ เช่น ขอบบัตรเครดิต ค่อยๆ กวาดเหล็กในออกจากผิวหนังอย่างระมัดระวัง</p>
    ...
    <div class="v2" id="v2">
        ...
        <div class="contact-1">
            <button id="helpButton2" class="first-aid" onclick="openPopup('popup2'); return false;">วิธีการปฐมพยาบาลเบื้องต้น</button>
        </div>
        <div id="popup2" class="popup">
            <div class="popup-content">
                <h2>วิธีการปฐมพยาบาลเบื้องต้น</h2>
                <p>1.ผื่นคันทั่วไป  ใช้โลชั่นทาตามร่างกายเพื่อบรรเทาอาการคันจากผื่นขึ้นที่ตัวเบื้องต้นได้</p>
                <p>2.ผื่นภูมิแพ้ผิวหนัง อาบน้ำล้างเหงื่อหรือฝุ่นออก กินยาแก้แพ้กลุ่มแอนตี้ฮีสตามีนและหลีกเลี่ยงการใส่เสื้อผ้ารัดรูป เพราะจะยิ่งทำให้เกิดการเสียดสี กระตุ้นให้เกิดการแพ้มีผื่นขึ้นตามตัวและคันมากขึ้น</p>
                <p>3.ผื่นแพ้สัมผัส สังเกตว่าเกิดผื่นแพ้หลังจากสัมผัสสิ่งใด และหลีกเลี่ยงสารที่ก่อให้เกิดอาการผื่นแพ้สัมผัส ใช้ยากลุ่มสเตียรอยด์ หากมีอาการคันร่วมด้วย สามารถรับประทานยาแก้แพ้ร่วมได้ </p>
    ...
    <div class="v3" id="v3">
        ...
        <div class="contact-1">
            <button id="helpButton3" class="first-aid" onclick="openPopup('popup3'); return false;">วิธีการปฐมพยาบาลเบื้องต้น</button>
        </div>
        <div id="popup3" class="popup">
            <div class="popup-content">
                <h2>วิธีการปฐมพยาบาลเบื้องต้น</h2>
                <p>1. ล้างด้วยน้ำสะอาดที่อุณหภูมิปกติ เพื่อลดความร้อนให้มากที่สุด</p>
                <p>2. หลังจากนั้นซับด้วยผ้าแห้งสะอาด แล้วสังเกตว่าถ้าผิวหนังมีรอยถลอก มีตุ่มพองใสหรือมีสีของผิวหนังเปลี่ยนไป ควรรีบไปพบแพทย์</p>
