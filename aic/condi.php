...
<body>
    <div id="main-content">
        ...
        <div class="contact">
            ...
            <a href="#" id="heatstrokeButton" class="heatstroke" data-class="d3">โรคลมเหตุร้อน หรือ
                ฮีทสโตรก </a>
    ...
    <div class="d1" id="d1">
        ...
        <div class="contact-2">
            <button id="precautionsButton1" class="precautions"
                onclick="openPopup('precautionsPopup1'); return false;">วีดีโอ</button>
        </div>
        <div id="precautionsPopup1" class="popup">
            <div class="popup-content">
             <h2>ข้อควรระวัง</h2>
             <p>ระวังการใช้แรงที่มากหรือน้อยเกินไปกับผู้ป่วยที่อายุและสรีละต่างกัน</p>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/3meNRTjyrRQ" frameborder="0" allowfullscreen></iframe>
    ...
    <div class="d3" id="d3">
        ...
        <h1 id="Title">โรคลมเหตุร้อนหรือฮีทสโตรก</h1>
        <div class="contact-1">
    ...
    <div class="d4" id="d4">
        ...
        <h1 id="Title">ช็อก</h1>
        <p>เป็นภาวะที่เลือดไปเลี้ยงอวัยวะต่าง ๆ ได้ไม่เพียงพอ อาจมีสาเหตุ
จากการเสียน้ํา เสียเลือด หัวใจล้มเหลว แพ้อย่างรุนแรง หรือจากการเจ็บปวดอย่างรุนแรง</p>
        <div class="contact-1">
        ...
        <div id="precautionsPopup4" class="popup">
            ...
            <div class="popup-content">
                ...
                <p>คลิปสอน CPR
                <iframe width="560" height="315" src="https://www.youtube.com/embed/3meNRTjyrRQ" frameborder="0" allowfullscreen></iframe></p>
